        ...
        headers: [
          ...
          // Allows: self, inline styles, Vercel analytics, Google Fonts, iKhokha payment redirects
          {
            ...
            value: [
              ...
              "connect-src 'self' https://fltjcycovhslqupmalfj.supabase.co https://api.ikhokha.com https://api.shiplogic.com https://sandbox.shiplogic.com https://api.portal.thecourierguy.co.za https://autosuggest.search.hereapi.com https://lookup.search.hereapi.com https://geocode.search.hereapi.com",
              "form-action 'self'",
