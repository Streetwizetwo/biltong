...
export function AddressAutocomplete({
  ...
  // Dropdown content (shared between inline and portal rendering)
    ...
    <div className="relative">
      <div className="relative">
        ...
        <input
          ...
          onFocus={() => { setShowDropdown(true); updateDropdownPos(); }}
      ...
      {showDropdown && displayPredictions.length > 0 && query.length >= 2 && !detailsLoading && typeof window !== "undefined" &&
        createPortal(
          <div
            ref={dropdownRef}
            className="fixed bg-[#2A1508] rounded-xl max-h-[260px] overflow-y-auto z-[9999] shadow-2xl border border-[#E5B83C]/20"
            style={{
      ...
      {showDropdown &&
        ...
        createPortal(
          <div
            className="fixed bg-[#2A1508] rounded-xl z-[9999] shadow-2xl border border-[#E5B83C]/20 p-3"
            style={{
              top: `${dropdownPos.top}px`,
              left: `${dropdownPos.left}px`,
              width: `${dropdownPos.width}px`,
      ...
      {/* Loading details message via Portal */}
      {detailsLoading && typeof window !== "undefined" &&
        createPortal(
          <div
            className="fixed bg-[#2A1508] rounded-xl z-[9999] shadow-2xl border border-[#E5B83C]/20 p-3"
            style={{
